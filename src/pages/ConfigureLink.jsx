...
const ConfigureLink = () => {
    ...
    const [enlace, setEnlace] = useState({
        password: "", recaptcha: false, dateActivation: "", dateExpiration: "", requireLogin: false,
    });
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_API}/link/${id}`, {
            ...
            setEnlace({
                ...response.data,
                dateActivation: response.data.dateActivation ? response.data.dateActivation.split("T")[0] : "",
                dateExpiration: response.data.dateExpiration ? response.data.dateExpiration.split("T")[0] : "",
            });
        }).catch((error) => {
    ...
    const handleChange = (e) => {
        ...
        setEnlace({
            ...enlace, [name]: type === "checkbox" ? checked : value,
        });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                title: "Configuración guardada con éxito", icon: "success", customClass: {
